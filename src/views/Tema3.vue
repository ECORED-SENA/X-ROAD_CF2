  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal
      .titulo-principal__numero
        .h3 3 
      .h3 Principios - Proceso de priorización de servicios de intercambio de información

    img.mb-5.img-a(src="@/assets/curso/tema_3/img_1.png")
      ...
      .row.m-0.align-items-center.justify-content-between
        ...
        .col-lg-5
          .bloque-texto-a__texto.p-4
            p #[strong Recomendación 1] 
            | Pedir a los ciudadanos y empresas, en la medida de lo posible según la legislación vigente, solamente información relevante y única.
    
    .bloque-texto-b.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
            ...
            .col-lg-10
              ...
              ol.lista-ol
                ...
                li 
                  span #[strong 2.] La interoperabilidad debe ser utilizada por parte de #[strong organizaciones privadas] cuando interactúen con el Estado.
                li 
                  span #[strong 3.] Cada entidad debe vincular los servicios de intercambio de información a los #[strong Servicios Ciudadanos Digitales] mediante el servicio de interoperabilidad y su integración a la plataforma de Interoperabilidad, de acuerdo con los lineamientos dados en la materia.

        .col-lg-5
          .bloque-texto-a__texto.p-4
            p #[strong Recomendación 2] 
            | Garantizar que las estrategias, planes y proyectos de la entidad, estén en consonancia con el marco de interoperabilidad y, en caso necesario, adaptarlos y ampliarlos para abordar el contexto y las necesidades de los ciudadanos y empresas.

    .bloque-texto-blue_1.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
    ...
    .bloque-texto-blue_2.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
        ...
        .col-lg-5
          .bloque-texto-blue_2__texto.p-4.mb-3
            p #[strong Recomendación 5]
            | Los esquemas de interoperabilidad deberán fomentar la participación y colaboración de las entidades, empresas, academia y entes internacionales para el intercambio de conocimiento útil que le permita al Estado una mayor y mejor entrega de servicios e información al ciudadano.

    .bloque-texto-blue_3.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
        ...
        .col-lg-5
          .bloque-texto-blue_3__texto.p-4.mb-3
            p #[strong Recomendación 6]
            | Los servicios de intercambio de información deben responder a la necesidad concreta que buscan atender, fomentando siempre que su construcción, operación y mantenimiento minimicen la complejidad administrativa, técnica y operativa involucrada.
          .bloque-texto-blue_3__texto.p-4
            p #[strong Recomendación 7]
            | Se deben simplificar los procesos y utilizar canales digitales siempre que sea apropiado para la prestación de trámites, servicios y otros procedimientos administrativos, para responder rápidamente y con una calidad elevada a las solicitudes de los usuarios y reducir la carga administrativa de las entidades públicas, las empresas y los ciudadanos.

    .bloque-texto-green.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
        ...
        .col-lg-5
          .bloque-texto-green__texto.p-4.mb-3
            p #[strong Recomendación 8]
            | No imponer herramientas o soluciones tecnológicas que sean específicas, ni desproporcionadas a las necesidades reales de los usuarios.
          .bloque-texto-green__texto.p-4
            p #[strong Recomendación 9]
            | Garantizar la estandarización de los datos, es decir, que los datos sean semántica y sintácticamente interpretables, transferibles entre las aplicaciones y sistemas de información.

    .bloque-texto-orange.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
        ...
        .col-lg-5
          .bloque-texto-orange__texto.p-4.mb-3
            p #[strong Recomendación 10]
            | Reutilizar y compartir conocimiento, experiencias y cooperar en el desarrollo de soluciones conjuntas durante la implementación de servicios de intercambio de información para los trámites, servicios y otros procedimientos administrativos.
          .bloque-texto-orange__texto.p-4
            p #[strong Recomendación 11]
            | Siempre que sea posible reutilizar y compartir información y datos durante la implementación de los trámites, servicios y otros procedimientos administrativos.

    .bloque-texto-orange2.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
        ...
        .col-lg-5
          .bloque-texto-orange2__texto.p-4.mb-3
            p #[strong Recomendación 12]
            p.mb-3 Asegurar que los conjuntos de datos susceptibles de intercambio cumplen con los criterios de calidad definidos.

            p Adicionalmente, que sus metadatos, semántica y sintaxis están disponibles para consulta y referencia.

    .bloque-texto-orange1.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-6.mb-4.mb-lg-0
          .row.justify-content-center.mb-3
            .col-lg-2
        ...
        .col-lg-5
          .bloque-texto-orange2__texto.p-4.mb-3
            p #[strong Recomendación 13]
            | Evaluar la efectividad y la eficiencia de los diferentes servicios de intercambio de información, la proporcionalidad y, el equilibrio entre costes y beneficios obtenidos.
</template>
